<?php
	...
	$queryGetSample = "SELECT sample.id,sample.deadline,pelanggan.nama,sample.status,sample.tgl FROM sample join pelanggan on sample.id_pelanggan = pelanggan.id ORDER BY sample.id ASC";
